...
The **STMicroelectronics NUCLEO-WB55RG Board Support Pack (BSP)**:
...
- Requires the [Device Family Pack (DFP) for the STM32WB series](https://www.keil.arm.com/packs/stm32wbxx_dfp-keil).
...
- [Examples/Blinky](https://github.com/Open-CMSIS-Pack/ST_NUCLEO-WB55RG_BSP/tree/main/Examples/Blinky) shows the basic usage of this board.

- [Board Layer](https://github.com/Open-CMSIS-Pack/ST_NUCLEO-WB55RG_BSP/tree/main/Layers/Default) for device-agnostic [Reference Applications](https://open-cmsis-pack.github.io/cmsis-toolbox/ReferenceApplications/) that implements these API interfaces:

| Provided API Interface        | Description
|:------------------------------|:------------------------------------------------------------------------------
| CMSIS_USB_Device              | CMSIS-Driver USB Device connected to User USB connector (CN1)
| CMSIS_VIO                     | CMSIS-Driver VIO connected to LEDs (LD1, LD2, LD3) and USER buttons (SW1, SW2, SW3)
...
By default the [Board Layers](https://github.com/Open-CMSIS-Pack/ST_NUCLEO-WB55RG_BSP/tree/main/Layers) are configured for the Arm Compiler 6 (AC6). Using STM32CubeMX it can be reconfigured for a different compiler. To configure it for the GCC compiler execute these steps:
