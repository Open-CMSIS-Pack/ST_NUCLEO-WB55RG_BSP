/******************************************************************************
 * @file     vio_NUCLEO-WB55RG.c
 * @brief    Virtual I/O implementation for board NUCLEO-WB55RG
 * @version  V1.0.0
...
|:--------------|:---------------|:---------------------|:------
| vioBUTTON0    | vioSignalIn.0  | USER button (SW1)    | PC4
| vioBUTTON1    | vioSignalIn.1  | USER button (SW2)    | PD0
| vioBUTTON2    | vioSignalIn.2  | USER button (SW3)    | PD1
| vioLED1       | vioSignalOut.1 | LED red     (LD3)    | PB1
| vioLED0       | vioSignalOut.0 | LED green   (LD2)    | PB0
| vioLED2       | vioSignalOut.2 | LED blue    (LD1)    | PB5
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTB(1),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED1,    GPIO_PIN_ID_PORTB(0),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED2,    GPIO_PIN_ID_PORTB(5),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH }
};
#endif
...
//  signal,     pin,                   pull resistor,      active state
  { vioBUTTON0, GPIO_PIN_ID_PORTC(4),  ARM_GPIO_PULL_UP, VIO_ACTIVE_LOW },
  { vioBUTTON1, GPIO_PIN_ID_PORTD(0),  ARM_GPIO_PULL_UP, VIO_ACTIVE_LOW },
  { vioBUTTON2, GPIO_PIN_ID_PORTD(1),  ARM_GPIO_PULL_UP, VIO_ACTIVE_LOW }
};
#endif
